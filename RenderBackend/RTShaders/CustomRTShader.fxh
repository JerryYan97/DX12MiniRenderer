...
;
; shader hash: 0f88aee024b778690f1b5f4800f9d585
;
; Buffer Definitions:
;
...
; <label>:165                                     ; preds = %160
  ...
  %173 = fsub fast float -0.000000e+00, %111
  %174 = fsub fast float -0.000000e+00, %112
  %175 = fsub fast float -0.000000e+00, %113
  %176 = call float @dx.op.dot3.f32(i32 55, float %173, float %174, float %175, float %170, float %171, float %172)  ; Dot3(ax,ay,az,bx,by,bz)
  ...
  %183 = fmul fast double %181, %182
  %184 = fcmp fast ogt double %183, 1.000000e+00
  br i1 %184, label %185, label %211

; <label>:185                                     ; preds = %165
  %186 = call float @dx.op.dot3.f32(i32 55, float %111, float %112, float %113, float %170, float %171, float %172)  ; Dot3(ax,ay,az,bx,by,bz)
  %187 = fmul fast float %186, 2.000000e+00
  %188 = fmul fast float %187, %170
  %189 = fmul fast float %187, %171
  %190 = fmul fast float %187, %172
  %191 = fsub fast float %111, %188
  %192 = fsub fast float %112, %189
  %193 = fsub fast float %113, %190
  %194 = fmul fast float %170, 0x3EE4F8B580000000
  %195 = fmul fast float %171, 0x3EE4F8B580000000
  %196 = fmul fast float %172, 0x3EE4F8B580000000
  %197 = fadd fast float %194, %118
  %198 = fadd fast float %195, %119
  %199 = fadd fast float %196, %120
  ...
  store <3 x float> %202, <3 x float>* %163, align 4, !tbaa !40
  %203 = call float @dx.op.dot3.f32(i32 55, float %191, float %192, float %193, float %191, float %192, float %193)  ; Dot3(ax,ay,az,bx,by,bz)
  %204 = call float @dx.op.unary.f32(i32 25, float %203)  ; Rsqrt(value)
  %205 = fmul fast float %191, %204
  %206 = fmul fast float %192, %204
  %207 = fmul fast float %193, %204
  ...
  store <3 x float> %210, <3 x float>* %164, align 4, !tbaa !40
  br label %385

; <label>:211                                     ; preds = %165
  %212 = call float @dx.op.dot3.f32(i32 55, float %111, float %112, float %113, float %111, float %112, float %113)  ; Dot3(ax,ay,az,bx,by,bz)
  %213 = call float @dx.op.unary.f32(i32 25, float %212)  ; Rsqrt(value)
  %214 = fmul fast float %213, %111
  %215 = fmul fast float %213, %112
  %216 = fmul fast float %213, %113
  %217 = call float @dx.op.dot3.f32(i32 55, float %214, float %215, float %216, float %170, float %171, float %172)  ; Dot3(ax,ay,az,bx,by,bz)
  %218 = fmul fast float %166, %166
  %219 = fmul fast float %217, %217
  %220 = fsub fast float 1.000000e+00, %219
  %221 = fmul fast float %218, %220
  %222 = fsub fast float 1.000000e+00, %221
  %223 = fcmp fast oge float %222, 0.000000e+00
  %224 = fmul fast float %214, %166
  %225 = fmul fast float %215, %166
  %226 = fmul fast float %216, %166
  %227 = call float @dx.op.unary.f32(i32 24, float %222)  ; Sqrt(value)
  %228 = fmul fast float %217, %166
  %229 = fadd fast float %228, %227
  %230 = fmul fast float %229, %170
  %231 = fmul fast float %229, %171
  %232 = fmul fast float %229, %172
  %233 = fsub fast float %224, %230
  %234 = fsub fast float %225, %231
  %235 = fsub fast float %226, %232
  %236 = select i1 %223, float %233, float 0.000000e+00
  %237 = select i1 %223, float %234, float 0.000000e+00
  %238 = select i1 %223, float %235, float 0.000000e+00
  %239 = insertelement <3 x float> undef, float %236, i32 0
  %240 = insertelement <3 x float> %239, float %237, i32 1
  %241 = insertelement <3 x float> %240, float %238, i32 2
  store <3 x float> %123, <3 x float>* %163, align 4, !tbaa !40
  store <3 x float> %241, <3 x float>* %164, align 4, !tbaa !40
  br label %385

; <label>:242                                     ; preds = %160
  %243 = fcmp fast oeq float %19, 1.000000e+00
  %244 = call float @dx.op.dot3.f32(i32 55, float %118, float %119, float %120, float 0x4037240460000000, float 0x4005523720000000, float 0xC03BE7B540000000)  ; Dot3(ax,ay,az,bx,by,bz)
  %245 = call float @dx.op.unary.f32(i32 12, float %244)  ; Cos(value)
  %246 = fmul fast float %245, 0x40C81CD6E0000000
  %247 = call float @dx.op.unary.f32(i32 22, float %246)  ; Frc(value)
  %248 = fadd fast float %118, %120
  %249 = call float @dx.op.dot2.f32(i32 54, float %248, float %119, float 0x4039FAC720000000, float 0x40638EE980000000)  ; Dot2(ax,ay,bx,by)
  %250 = call float @dx.op.unary.f32(i32 13, float %249)  ; Sin(value)
  %251 = fmul fast float %250, 0x40E55DD180000000
  %252 = call float @dx.op.unary.f32(i32 22, float %251)  ; Frc(value)
  %253 = fmul fast float %119, %120
  %254 = call float @dx.op.dot2.f32(i32 54, float %253, float %118, float 0x4039FAC720000000, float 0x40638EE980000000)  ; Dot2(ax,ay,bx,by)
  %255 = call float @dx.op.unary.f32(i32 13, float %254)  ; Sin(value)
  %256 = fmul fast float %255, 0x40E55DD180000000
  ...
  %260 = fmul fast float %247, 0x400B4BC6A0000000
  %261 = fmul fast float %252, 0x400B4BC6A0000000
  %262 = fmul fast float %259, 0x3FFB4BC6A0000000
  %263 = uitofp i32 %23 to float
  %264 = fmul fast float %263, -6.521250e+02
  %265 = call float @dx.op.unary.f32(i32 13, float %264)  ; Sin(value)
  %266 = fmul fast float %265, 0x40934BF580000000
  %267 = call float @dx.op.unary.f32(i32 22, float %266)  ; Frc(value)
  %268 = fmul fast float %267, 0x4029666660000000
  %269 = fmul fast float %268, %111
  %270 = fmul fast float %268, %112
  %271 = fmul fast float %268, %113
  %272 = fsub fast float %260, %269
  %273 = fsub fast float %261, %270
  %274 = fsub fast float %262, %271
  %275 = call %dx.types.CBufRet.i32 @dx.op.cbufferLoadLegacy.i32(i32 59, %dx.types.Handle %5, i32 5)  ; CBufferLoadLegacy(handle,regIndex)
  %276 = extractvalue %dx.types.CBufRet.i32 %275, 0
  %277 = uitofp i32 %276 to float
  %278 = fmul fast float %277, -6.521250e+02
  %279 = call float @dx.op.unary.f32(i32 13, float %278)  ; Sin(value)
  %280 = fmul fast float %279, 0x40934BF580000000
  %281 = call float @dx.op.unary.f32(i32 22, float %280)  ; Frc(value)
  %282 = fmul fast float %281, 0x40147C5D60000000
  %283 = fmul fast float %282, %155
  %284 = fmul fast float %282, %156
  %285 = fmul fast float %282, %157
  %286 = fadd fast float %283, %272
  %287 = fadd fast float %284, %273
  %288 = fadd fast float %285, %274
  %289 = call float @dx.op.dot3.f32(i32 55, float %286, float %287, float %288, float 0x4037240460000000, float 0x4005523720000000, float 0xC03BE7B540000000)  ; Dot3(ax,ay,az,bx,by,bz)
  %290 = call float @dx.op.unary.f32(i32 12, float %289)  ; Cos(value)
  %291 = fmul fast float %290, 0x40C81CD6E0000000
  %292 = call float @dx.op.unary.f32(i32 22, float %291)  ; Frc(value)
  %293 = fadd fast float %286, %288
  %294 = call float @dx.op.dot2.f32(i32 54, float %293, float %287, float 0x4039FAC720000000, float 0x40638EE980000000)  ; Dot2(ax,ay,bx,by)
  %295 = call float @dx.op.unary.f32(i32 13, float %294)  ; Sin(value)
  %296 = fmul fast float %295, 0x40E55DD180000000
  %297 = call float @dx.op.unary.f32(i32 22, float %296)  ; Frc(value)
  %298 = fmul fast float %287, %288
  %299 = call float @dx.op.dot2.f32(i32 54, float %298, float %286, float 0x4039FAC720000000, float 0x40638EE980000000)  ; Dot2(ax,ay,bx,by)
  %300 = call float @dx.op.unary.f32(i32 13, float %299)  ; Sin(value)
  %301 = fmul fast float %300, 0x40E55DD180000000
  %302 = call float @dx.op.unary.f32(i32 22, float %301)  ; Frc(value)
  %303 = fmul fast float %302, 2.000000e+00
  %304 = call float @dx.op.unary.f32(i32 6, float %303)  ; FAbs(value)
  %305 = fmul fast float %292, 2.000000e+00
  %306 = fmul fast float %297, 2.000000e+00
  %307 = fadd fast float %305, -1.000000e+00
  %308 = fadd fast float %306, -1.000000e+00
  %309 = fadd fast float %304, -1.000000e+00
  ...
  %317 = fadd fast float %305, 0xBFEFFFFDE0000000
  %318 = fadd fast float %306, 0xBFEFFFFDE0000000
  %319 = fadd fast float %304, 0xBFEFFFFDE0000000
  %320 = select i1 %316, float %317, float %307
  %321 = select i1 %316, float %318, float %308
  %322 = select i1 %316, float %319, float %309
  ...
  br i1 %243, label %325, label %360

; <label>:325                                     ; preds = %242
  %326 = call float @dx.op.binary.f32(i32 35, float %20, float 0.000000e+00)  ; FMax(a,b)
  %327 = call float @dx.op.binary.f32(i32 36, float %326, float 0x3FE99999A0000000)  ; FMin(a,b)
  %328 = fmul fast float %327, %324
  %329 = fmul fast float %328, %320
  %330 = fmul fast float %328, %321
  %331 = fmul fast float %328, %322
  %332 = call float @dx.op.dot3.f32(i32 55, float %111, float %112, float %113, float %155, float %156, float %157)  ; Dot3(ax,ay,az,bx,by,bz)
  %333 = fmul fast float %332, 2.000000e+00
  %334 = fmul fast float %333, %155
  %335 = fmul fast float %333, %156
  %336 = fmul fast float %333, %157
  %337 = fsub fast float %111, %334
  %338 = fsub fast float %112, %335
  %339 = fsub fast float %113, %336
  %340 = fmul fast float %155, 0x3EE4F8B580000000
  %341 = fmul fast float %156, 0x3EE4F8B580000000
  %342 = fmul fast float %157, 0x3EE4F8B580000000
  %343 = fadd fast float %340, %118
  %344 = fadd fast float %341, %119
  %345 = fadd fast float %342, %120
  %346 = insertelement <3 x float> undef, float %343, i32 0
  %347 = insertelement <3 x float> %346, float %344, i32 1
  %348 = insertelement <3 x float> %347, float %345, i32 2
  store <3 x float> %348, <3 x float>* %163, align 4, !tbaa !40
  %349 = call float @dx.op.dot3.f32(i32 55, float %337, float %338, float %339, float %337, float %338, float %339)  ; Dot3(ax,ay,az,bx,by,bz)
  %350 = call float @dx.op.unary.f32(i32 25, float %349)  ; Rsqrt(value)
  %351 = fmul fast float %337, %350
  %352 = fmul fast float %338, %350
  %353 = fmul fast float %339, %350
  %354 = fadd fast float %351, %329
  %355 = fadd fast float %352, %330
  %356 = fadd fast float %353, %331
  %357 = insertelement <3 x float> undef, float %354, i32 0
  %358 = insertelement <3 x float> %357, float %355, i32 1
  %359 = insertelement <3 x float> %358, float %356, i32 2
  store <3 x float> %359, <3 x float>* %164, align 4, !tbaa !40
  br label %385

; <label>:360                                     ; preds = %242
  %361 = fmul fast float %320, %324
  %362 = fmul fast float %321, %324
  %363 = fmul fast float %322, %324
  %364 = call float @dx.op.dot3.f32(i32 55, float %155, float %156, float %157, float %155, float %156, float %157)  ; Dot3(ax,ay,az,bx,by,bz)
  %365 = call float @dx.op.unary.f32(i32 25, float %364)  ; Rsqrt(value)
  %366 = fmul fast float %365, %155
  %367 = fmul fast float %365, %156
  %368 = fmul fast float %365, %157
  %369 = fadd fast float %366, %361
  %370 = fadd fast float %367, %362
  %371 = fadd fast float %368, %363
  %372 = fmul fast float %369, %369
  %373 = fmul fast float %370, %370
  ...
  %378 = fcmp fast olt float %377, 0x3EB0C6F7A0000000
  %379 = select i1 %378, float %366, float %369
  %380 = select i1 %378, float %367, float %370
  %381 = select i1 %378, float %368, float %371
  %382 = insertelement <3 x float> undef, float %379, i32 0
  %383 = insertelement <3 x float> %382, float %380, i32 1
  %384 = insertelement <3 x float> %383, float %381, i32 2
  store <3 x float> %123, <3 x float>* %163, align 4, !tbaa !40
  store <3 x float> %384, <3 x float>* %164, align 4, !tbaa !40
  br label %385

; <label>:385                                     ; preds = %360, %325, %211, %185
  %386 = getelementptr inbounds %struct.Payload, %struct.Payload* %payload, i32 0, i32 0
  %387 = load <3 x float>, <3 x float>* %386, align 4, !tbaa !40
  %388 = extractelement <3 x float> %387, i32 0
  %389 = fmul fast float %388, %15
  %390 = extractelement <3 x float> %387, i32 1
  %391 = fmul fast float %390, %16
  %392 = extractelement <3 x float> %387, i32 2
  %393 = fmul fast float %392, %17
  %394 = insertelement <3 x float> undef, float %389, i32 0
  %395 = insertelement <3 x float> %394, float %391, i32 1
  %396 = insertelement <3 x float> %395, float %393, i32 2
  store <3 x float> %396, <3 x float>* %386, align 4, !tbaa !40
  br label %404

; <label>:397                                     ; preds = %45
  %398 = getelementptr inbounds %struct.Payload, %struct.Payload* %payload, i32 0, i32 0
  %399 = load <3 x float>, <3 x float>* %398, align 4, !tbaa !40
  %400 = extractelement <3 x float> %399, i32 0
  %401 = insertelement <3 x float> undef, float %400, i32 0
  %402 = insertelement <3 x float> %401, float 0.000000e+00, i32 1
  %403 = shufflevector <3 x float> %402, <3 x float> %399, <3 x i32> <i32 0, i32 1, i32 5>
  store <3 x float> %403, <3 x float>* %398, align 4, !tbaa !40
  br label %404

; <label>:404                                     ; preds = %397, %385, %31
  ret void
}
...
const unsigned char CustomRTShader[] = {
  0x44, 0x58, 0x42, 0x43, 0x64, 0x82, 0x28, 0x01, 0x7f, 0x81, 0x8a, 0x5d,
  0xb1, 0x72, 0xa5, 0xae, 0x70, 0x30, 0xa9, 0xee, 0x01, 0x00, 0x00, 0x00,
  0xe4, 0x36, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
  ...
  0x14, 0x68, 0x40, 0x51, 0x14, 0x3d, 0x41, 0xb1, 0x26, 0x14, 0x07, 0x5d,
  0x0b, 0x15, 0x30, 0x80, 0xac, 0x35, 0x30, 0x02, 0x40, 0x8b, 0x19, 0x00,
  ...
  0x3d, 0xa0, 0x89, 0x9a, 0xb0, 0x89, 0x9b, 0xc0, 0x89, 0x9c, 0xd0, 0x89,
  0x69, 0x27, 0x2e, 0x9e, 0xe8, 0x83, 0x2a, 0x6c, 0x6c, 0x76, 0x6d, 0x2e,
  ...
  0x22, 0x0c, 0x02, 0x0c, 0x86, 0xcb, 0x77, 0x1e, 0x7f, 0x40, 0xa4, 0x07,
  0x98, 0x84, 0x63, 0x05, 0x30, 0xa9, 0x43, 0x18, 0xa2, 0x91, 0x10, 0xa7,
  0x91, 0x7c, 0xe4, 0xb6, 0x2d, 0x62, 0x1b, 0x2e, 0xdf, 0x79, 0xfc, 0x01,
  ...
  0xba, 0xfd, 0xe2, 0xb6, 0x0d, 0x83, 0x1a, 0x2e, 0xdf, 0x79, 0x7c, 0xa4,
  0x91, 0x26, 0xa0, 0x11, 0x08, 0xb1, 0xf3, 0x91, 0xdb, 0x36, 0x8e, 0x6b,
  0xb8, 0x7c, 0xe7, 0xf1, 0x9d, 0x20, 0x21, 0x84, 0xa9, 0x75, 0x60, 0x27,
  0x5a, 0x06, 0xbf, 0xb8, 0x6d, 0xbb, 0xc0, 0x86, 0xcb, 0x77, 0x1e, 0xff,
  ...
  ,
  ...
  0xd4, 0x2c, 0xc3, 0x08, 0x10, 0xa0, 0x67, 0x19, 0x46, 0x80, 0x07, 0x45,
  0xcb, 0x30, 0x02, 0x1c, 0x68, 0x3a, 0x10, 0x30, 0x47, 0x10, 0xcc, 0x11,
  0x80, 0x02, 0x01, 0xc8, 0x32, 0x05, 0x40, 0x9b, 0x21, 0x80, 0x61, 0x84,
  ...
  0xa4, 0x90, 0x21, 0x23, 0x45, 0x44, 0x00, 0x86, 0x01, 0x00, 0xf3, 0x0c,
  0x00, 0x98, 0x6b, 0x00, 0xc0, 0x6c, 0x03, 0x00, 0xe6, 0x1b, 0x00, 0x30,
  0xdf, 0x00, 0x80, 0x19, 0x07, 0x00, 0x30, 0xe4, 0xa1, 0x00, 0x00, 0x08,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0xc8, 0x93, 0x01, 0x00,
  0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x90, 0xc7, 0x03,
  ...
  0x51, 0x14, 0x5e, 0x39, 0x94, 0x02, 0x59, 0x47, 0x00, 0xe8, 0x5a, 0xa8,
  ...
  ,
  ...
  0xe2, 0x60, 0x03, 0xb2, 0xb4, 0x81, 0x1b, 0x2c, 0xcb, 0xf0, 0x06, 0xc0,
  ...
  0x83, 0x3c, 0xd0, 0x03, 0x3e, 0x20, 0x30, 0x41, 0xb8, 0x85, 0x3b, 0xd8,
  ...
  0x00, 0x39, 0x98, 0x20, 0x00, 0x73, 0x30, 0x41, 0x00, 0xe8, 0x60, 0x82,
  0x00, 0xd4, 0xc1, 0x86, 0x60, 0xd9, 0x80, 0x18, 0xa3, 0x90, 0x90, 0x42,
  ...
  0x86, 0x40, 0x16, 0x26, 0x08, 0xb7, 0x80, 0x07, 0x1b, 0x86, 0x58, 0x98,
  ...
  ,
  ...
  ,
  ...
  0x16, 0xb6, 0x0c, 0xb6, 0x11, 0xdc, 0xc2, 0x96, 0xc1, 0x3e, 0x82, 0x5b,
  0xd8, 0x32, 0xdc, 0x47, 0x70, 0x0b, 0x5b, 0x86, 0x71, 0x09, 0x6e, 0x61,
  0xcb, 0xf0, 0x2e, 0xc1, 0x2d, 0x6c, 0x19, 0x52, 0x26, 0xb8, 0x85, 0x2d,
  0x83, 0xca, 0x04, 0xb7, 0xb0, 0x65, 0x68, 0x99, 0xe0, 0x16, 0xb6, 0x0c,
  0x37, 0x13, 0xdc, 0xc2, 0x96, 0x41, 0x67, 0x82, 0x5b, 0xd8, 0x32, 0xfc,
  0x4c, 0x70, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
